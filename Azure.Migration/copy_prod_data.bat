...
robocopy C:\Data\eventstore \\tsclient\F\Data\data_from_production *.chk

REM 2) copy indexes
robocopy C:\Data\eventstore\index \\tsclient\F\Data\data_from_production\index /mir
...
robocopy C:\Data\eventstore \\tsclient\F\Data\data_from_production chunk*.* /ia:R
